...
const DEFAULT_LOGOS = {
    ...
    food99: "https://logodownload.org/wp-content/uploads/2020/11/99-food-logo-0.png"
};
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-8 max-w-5xl mx-auto">
                    ...
                    >
                        <div className="flex items-center justify-center md:justify-start gap-2 mb-2 text-brand-600">
                            ...
                            <span className="font-bold text-sm uppercase tracking-widest">Delivery</span>
                        </div>
                        ...
                        {businessInfo?.ifood && (
                            ...
                            >
                                <div className="w-12 h-12 bg-red-50 rounded-full flex items-center justify-center p-2 group-hover:scale-110 transition-transform">
                                    <img src={deliveryLogos?.ifood} alt="iFood" className="w-full h-full object-contain" />
                                </div>
                                <div className="text-left">
                                    <span className="block text-xs text-gray-400 font-medium uppercase">Pedir pelo</span>
                                    <span className="block text-red-500 font-bold text-lg">iFood</span>
                                </div>
                            </motion.a>
                        )}
                        ...
                        {businessInfo?.food99 && (
                            ...
                            >
                                <div className="w-12 h-12 bg-yellow-50 rounded-full flex items-center justify-center p-2 group-hover:scale-110 transition-transform">
                                    <img src={deliveryLogos?.food99} alt="99Food" className="w-full h-full object-contain mix-blend-multiply" />
                                </div>
                                <div className="text-left">
                                    <span className="block text-xs text-gray-400 font-medium uppercase">Pedir pelo</span>
                                    <span className="block text-yellow-600 font-bold text-lg">99Food</span>
                                </div>
                            </motion.a>
                        )}
                    </motion.div>
